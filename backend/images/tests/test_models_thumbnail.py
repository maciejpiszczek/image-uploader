...
def test_thumbnail_creation(db, create_test_thumbnail, create_test_image, remove_test_data):
    ...
    assert create_test_thumbnail.url.url == '/media/resized_images/test_resized_file.png'
    assert create_test_thumbnail.height == 200
    assert create_test_thumbnail.__str__(), 'resized_images/test_resized_file.png'
